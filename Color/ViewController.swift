...
//  ColorPicker
//
//  Created by yongseopKim on 2022/09/18.
//
...
class ViewController: UIViewController {
    ...
    private struct ViewTag {
        ...
        static let sliderAlhpa: Int = 103
    }
    ...
    @IBAction func sliderValueChanged(_ sender: UISlider) {
        guard (ViewTag.sliderRed...ViewTag.sliderAlhpa).contains(sender.tag) else {
    ...
    private func matchViewColorWithCurrentValue() {
        ...
        guard let redSlider: UISlider = self.view.viewWithTag(ViewTag.sliderRed) as? UISlider,
              ...
              let alphaSlider: UISlider = self.view.viewWithTag(ViewTag.sliderAlhpa) as? UISlider else {
            return
        }
